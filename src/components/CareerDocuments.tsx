    ...
    <section id="documents" className="py-20">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <h2 className="text-3xl font-bold md:text-5xl">
          Evidence beyond the portfolio
        </h2>
        <p className="mt-5 max-w-2xl text-base leading-7 opacity-70">
          Resume, cover letter and professional recommendations are available
          for recruiters who want a deeper view of my background.
        </p>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          {documents.map((doc) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              onClick={() => trackPortfolioEvent(doc.event)}
              className="group rounded-2xl border border-black/10 bg-white/5 p-6 transition hover:-translate-y-1"
            >
